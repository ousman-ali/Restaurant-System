                ...
                @foreach($orders as $order)
                    @if($order->served_by == $k->id)
                        ...
                        <tr>
                            ...
                            <td>{{$order->kitchen ? $order->kitchen->name : ""}}</td>
        ...
        $(document).ready(function () {
            ...
            new Morris.Bar({
                ...
                data: [
                    ...
                    {
                        year: '{{$k->name}}' + '',
                        value: {{count(\App\Models\Order::where('served_by',$k->id)->whereBetween('created_at',array($start,$end))->get())}}
                    },
                    @endforeach
                ],
