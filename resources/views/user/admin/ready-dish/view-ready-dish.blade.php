    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a href="{{url('/all-ready-dish')}}" class="btn btn-default waves-effect">All Dish <span class="m-l-5"></span></a>
            </div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{url('/all-ready-dish')}}">Dishes</a>
                </li>
                <li class="active">
                    {{$dish->dish}}
                </li>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="dish-image-container">
                        <img src="{{ url($dish->thumbnail) }}" alt="{{ $dish->name }}" class="dish-image img-responsive">
                    </div>
                </div>
                ...
                <div class="col-md-7">
                    <ul class="price-list">
                            <li class="price-item">
                                <span class="price-type">{{ $dish->name }}</span>
                                <span class="price-value">
                                    {{ config('restaurant.currency.symbol') }} {{ $dish->price }} {{ config('restaurant.currency.currency') }}
                                </span>
                            </li>
                    </ul>
                </div>
