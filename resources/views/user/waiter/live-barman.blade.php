    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('/barman-status')}}">Barman Status</a></li>
            </ol>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#refresh").on('click',function () {
                $.get('/barman-status-waiter-json', function (data) {
                    console.log(data);
                    orders = data;
                        ...
                        $("<div>", {class: "col-lg-6"}).append(
                            $("<div>", {class: dish.status == 0 ? "panel panel-color panel-warning" : "panel panel-color panel-custom",
                                ...
                                $("<div>", {class: "panel-heading"}).append(
                                    $("<h3>", {
                                        class: "panel-title",
                                        text: dish.kitchen ? dish.kitchen.name : "Barman did not response yet"
                                    }).append(
