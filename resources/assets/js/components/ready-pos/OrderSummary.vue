                ...
                <div class="modal-body">
                    ...
                    <div class="model-footer">
                        <div style="display: flex; gap: 15px; width: 100%;">
                            <button class="btn btn-outline ladda-button" data-style="expand-right" data-spinner-color="#000" @click="(e) => saveOrderWithLoading(e, false)" role="button">
                                Complete Order
                            </button>
                            <button class="btn btn-success btn-block" data-style="expand-right" data-spinner-color="#fff" @click="(e) => saveOrderWithLoading(e, true)" role="button">
