...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - A Culinary Adventure</title>
    <!-- Bootstrap 5 CSS -->
    <link
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom-dark sticky-top">
    <div class="container">
        <a class="navbar-brand" href="#">
            ...
            <span class="text-custom-primary"><?php echo e(config('app.name')); ?></span>
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="nav-item">
                        <a class="nav-link" href="#<?php echo e($menu->section_id); ?>"><?php echo e($menu->name); ?></a>
                    </li>
                    ...
                    <li class="nav-item ms-2">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(!\App\Models\User::first()): ?>
                                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Join</a>
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php $__currentLoopData = $webPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($section->section_id == 'menu' || \Illuminate\Support\Str::contains($section->content, 'id="menus"')): ?>
        <?php echo $__env->make('menus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
