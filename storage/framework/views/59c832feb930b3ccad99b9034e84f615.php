    ...
    <div class="container">
        ...
        <div class="d-flex flex-wrap justify-content-center mb-4">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button
                    ...
                    onclick="filterDishes(<?php echo e($category->id); ?>)"
                >
        ...
        <div class="row" id="menu-items-container">
            <?php $__currentLoopData = $dishes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 mb-4 menu-item" data-category="<?php echo e($dish->category_id ?? 'uncategorized'); ?>" data-dish-id="<?php echo e($dish->id); ?>">
                    <div class="card menu-card h-100">
                        <div class="position-relative">
                            <img
                                src="<?php echo e($dish->thumbnail); ?>"
                                class="card-img-top menu-img"
                                alt="<?php echo e($dish->dish); ?>"
                            />
                            <?php if($dish->category_id && ($category = \App\Models\DishCategory::find($dish->category_id))): ?>
                                <span class="menu-badge bg-custom-primary"><?php echo e($category->name); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title"><?php echo e($dish->dish); ?></h4>
                            <div class="mt-3">
                                <div class="portion-options">
                                    <div class="d-flex flex-column gap-2">
                                        <?php $__currentLoopData = $dish->dishPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="portion-option p-2 border rounded bg-light">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <span class="fw-bold"><?php echo e($price->dish_type); ?></span>
                                                    <span class="badge bg-custom-primary"><?php echo e($price->price); ?></span>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                            ...
                            <div class="dish-images-data" style="display: none;">
                                <?php $__currentLoopData = $dish->dishImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        data-image="<?php echo e($image->image); ?>"
...
<?php /**PATH C:\xampp\htdocs\Restaurant\resources\views/menus.blade.php ENDPATH**/ ?>